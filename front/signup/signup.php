...
<body>
  <section class="login-form">
    <h1><a href="../index.php" class="logo">DCU직방</a></h1>
    <form action="../api/router/auth/signup.php" method="POST" class="right">
      ...
      <div id="contnet">
        ...
        <div id="bir_wrap">
          ...
          <div id="bir_mm">
            <span class="box">
              <input type="text" id="dd" class="int" maxlength="2" placeholder="월(2자)">
            </span>
          </div>
          <!-- BIRTH_DD -->
          <div id="bir_dd">
      ...
      <h3>성별</h3>
      <span class="gender_select" id="">
        <select id="signup-gender" class="selectbox" name="gender" style="color: gray;">
